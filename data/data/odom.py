...
class EncoderToOdomNode(Node):
    def __init__(self):
        ...
        self.get_logger().info("EncoderToOdomNode started")
    ...
    def update_odom(self):
        ...
        # Tính toán vận tốc trung bình và tốc độ góc
        ...
        # Đảm bảo theta luôn trong khoảng [-pi, pi]
